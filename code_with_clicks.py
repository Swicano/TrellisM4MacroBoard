...
macro_config_LUT = {
    ...
    (1,4): (0x04bb04, TOGGLE_REP, 0.01, MOUSE, (Mouse.LEFT_BUTTON, )),
    # # intentional blank button
    (3,4): (0xbb0404, PRESS, 0.01, MOUSE, (Mouse.LEFT_BUTTON, )),
...
def press(button, time_interval):
  ...
  if time_interval < 0.001:    
    ...
    elif macro_config_LUT[button][3] == MOUSE:
      ms.press(*macro_config_LUT[button][4])
      ms.release(*macro_config_LUT[button][4])
    else:
